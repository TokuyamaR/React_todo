...
// Sample01
//=============================================
// renderメソッドにて、第２引数のDOMに第１引数のHTMLを挿入する
ReactDOM.render(
    <h1>Hello World!</h1>,
...
//=============================================
// Sample03 コンポーネントとprops（ES6での書き方）ex)classの概念,変数let,定数const
//=============================================
...
const element2 = <Welcome name="Miho"/>;
ReactDOM.render(
    element2,
...
class Clock3 extends React.Component {
    constructor(props) {
        ...
        super(props); // 親コンポーネントのstateに値を渡す
    ...
    tick() {
        ...
        // setStateにてstateを変更しないとrenderが走らない
        this.setState({
            date: new Date()
        });
    }
